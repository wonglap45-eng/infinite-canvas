...
十二、最终可复制中文提示词
输出一段可以直接连接“用户自己的产品参考图”使用的中文生图提示词。提示词必须包含：新产品主体保真、构图方式、主体位置、画面比例、背景、光线、材质、文字区/信息区处理、商业用途、质量标准、负面约束。不要写“如图所示”“参考上图”这种离开原图就无法理解的表达。

十三、5 个同风格变体提示词
给出 5 个同一视觉体系下的中文变体提示词，分别偏向不同方向，例如：极简高端主图、科技成分氛围图、功能卖点图、场景副图、A+ 详情页图。每个变体都必须强调“以用户上传的新产品图作为唯一产品主体”。`;
